...
[_LOWER] = LAYOUT( \
  ...
  S(KC_GRV), _______, KC_CUT,  KC_COPY, KC_PSTE, C(KC_J), _______, _______, XXXXXXX, KC_PIPE, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_LPRN, KC_1,    KC_2,    KC_3,    KC_RPRN,                   KC_PSCR, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_P0,
