...
[_DVORAK] = LAYOUT( \
  ...
  KC_LSFT, KC_SCLN, KC_Q,    KC_J,   KC_K, KC_X, KC_LBRC, KC_RBRC, KC_B, KC_M,   KC_W,   KC_V, KC_Z, KC_RSFT, \
                     KC_LCTRL, KC_LALT, LOWER, KC_SPC,       KC_ENT, RAISE, KC_BSPC, KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT( \
  ...
  S(KC_GRV), _______, KC_CUT,  KC_COPY, KC_PSTE, XXXXXXX, _______, _______, XXXXXXX, KC_PIPE, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
